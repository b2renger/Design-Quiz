...
// FIX: Wrapped the entire script in an IIFE to prevent global scope pollution
// and resolve "Cannot redeclare block-scoped variable" errors.
(() => {
    const fullQuizData = {
        en: [
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const pioneerImageEl = document.getElementById('pioneer-image') as HTMLImageElement;
        ...
        function getShuffledQuestions(difficulty: string): any[] {
        ...
        function displayQuestion() {
            ...
            currentQuestion.options.forEach((answer: string, index: number) => {
        ...
        function handleAnswerSelect(e: Event) {
        ...
        function displayResult(isCorrect: boolean, questionData: any) {
            questionScreen.classList.add('hidden');
            ...
            const learnMoreEl = resultScreen.querySelector('[data-translate-key="learnMore"]') as HTMLElement;
